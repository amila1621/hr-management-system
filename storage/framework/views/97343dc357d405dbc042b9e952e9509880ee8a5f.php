...
<div class="content-page">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <a href="<?php echo e(route(Route::currentRouteName(), ['week' => Carbon\Carbon::parse($selectedDate)->subWeek()->format('Y-m-d')])); ?>"
                                class="btn btn-outline-primary">
                                <i class="fas fa-chevron-left"></i> Previous Week
                            </a>
                            <a href="<?php echo e(route(Route::currentRouteName(), ['week' => Carbon\Carbon::parse($selectedDate)->addWeek()->format('Y-m-d')])); ?>"
                                class="btn btn-outline-primary">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="<?php echo e(route('supervisor.populate-previous-week', ['week' => $selectedDate])); ?>"
                                class="btn border-success text-success copy-btn mr-2"
                                id="copyPreviousWeekBtn">
                                <i class="fas fa-copy"></i> Copy Last Week
                            </a>
                            <a href="<?php echo e(route('supervisor.clear-current-week', ['week' => $selectedDate])); ?>"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" id="departmentTabs" role="tablist">
                                <?php $__currentLoopData = $staffByDepartment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department => $departmentStaff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link <?php echo e($loop->first ? 'active' : ''); ?>"
                                        id="tab-<?php echo e(Str::slug($department)); ?>"
                                        data-toggle="tab"
                                        href="#dept-<?php echo e(Str::slug($department)); ?>"
                                        role="tab"
                                        aria-controls="dept-<?php echo e(Str::slug($department)); ?>"
                                        aria-selected="<?php echo e($loop->first ? 'true' : 'false'); ?>">
                                        <?php echo e($department); ?>

                                        <span class="badge badge-secondary ml-1"><?php echo e($departmentStaff->count()); ?></span>
                                    </a>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                            ...
                            <div class="tab-content" id="departmentTabContent">
                                ...
                                <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?>"
                                    id="dept-<?php echo e(Str::slug($department)); ?>"
                                    role="tabpanel"
                                    aria-labelledby="tab-<?php echo e(Str::slug($department)); ?>">

                                    <div class="mt-3">
                                        <!-- Update each department form to include the department name -->
                                        <form action="<?php echo e(route('supervisor.working-hours.store')); ?>" method="POST" class="department-form">
                                            <?php echo csrf_field(); ?>
    ...
    <td class="<?php echo e(in_array($dateString, $holidays->toArray()) ? '' : ''); ?>">
        <input type="text" name="reception[<?php echo e($dateString); ?>]"
            value="<?php echo e(isset($organizedReceptionData[$dateString][$department]) ? $organizedReceptionData[$dateString][$department] : ''); ?>"
            class="form-control form-control-sm"
            placeholder="Notes for <?php echo e($department); ?>">
    </td>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</tr>

                                                        <!-- Department Staff rows -->
                                                        <?php $__currentLoopData = $departmentStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr data-staff-id="<?php echo e($staff->id); ?>" data-staff-email="<?php echo e($staff->email); ?>">
                                                            <td><?php echo e($staff->name); ?></td>
                                                            <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php
                                                            $dateString = $date->format('Y-m-d');
                                                            $staffHourEntry = $staffHours[$staff->id][$dateString] ?? null;
                                                            $hoursData = $staffHourEntry['hours_data'] ?? [];
                                                            $isApproved = $staffHourEntry['is_approved'] ?? 1; // Default to approved if not set
                                                            $staffDateKey = $staff->id . '_' . $dateString;
                                                            $sickLeaveInfo = $sickLeaveStatuses[$staffDateKey] ?? null;
                                                            ?>
                                                            <td class="<?php echo e(in_array($dateString, $holidays->toArray()) ? '' : ''); ?>">
                                                                <!-- Display sick leave status if exists -->
                                                                <?php if($sickLeaveInfo): ?>
                                                                <?php
                                                                $statusText = '';
                                                                $statusClass = '';
                                                                ...
                                                                <div class="alert alert-warning alert-sm mb-2 p-2" style="font-size: 12px; line-height: 1.3;">
                                                                    <strong class="<?php echo e($statusClass); ?>"><?php echo e($statusText); ?></strong>
                                                                    <?php if($sickLeaveInfo->description): ?>
                                                                    <br><small><strong>Description:</strong> <?php echo e($sickLeaveInfo->description); ?></small>
                                                                    <?php endif; ?>
                                                                    <?php if($sickLeaveInfo->supervisor_remark): ?>
                                                                    <br><small><strong>Supervisor:</strong> <?php echo e($sickLeaveInfo->supervisor_remark); ?></small>
                                                                    <?php endif; ?>
                                                                    <?php if($sickLeaveInfo->admin_remark): ?>
                                                                    <br><small><strong>Admin:</strong> <?php echo e($sickLeaveInfo->admin_remark); ?></small>
                                                                    <?php endif; ?>
                                                                    <?php if($sickLeaveInfo->start_date && $sickLeaveInfo->end_date): ?>
                                                                    <br><small><strong>Period:</strong> <?php echo e(Carbon\Carbon::parse($sickLeaveInfo->start_date)->format('M d')); ?> - <?php echo e(Carbon\Carbon::parse($sickLeaveInfo->end_date)->format('M d, Y')); ?></small>
                                                                    <?php endif; ?>
                                                                </div>
                                                                <?php endif; ?>

                                                                <div class="time-slots <?php echo e($isApproved == 0 ? 'unapproved-hours' : ''); ?>">
                                                                    <?php $__empty_1 = true; $__currentLoopData = $hoursData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $timeRange): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                    <div class="time-slot mb-1 <?php echo e($isApproved == 0 ? 'unapproved-entry' : ''); ?>">
                                                                        <div class="time-input-container <?php echo e($isApproved == 0 ? 'unapproved-container' : ''); ?>">
                                                                            <?php
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                id="hidden-time-<?php echo e($staff->id); ?>-<?php echo e($dateString); ?>-<?php echo e($index ?? 0); ?>"
                                                                                value="<?php echo e($hiddenValue); ?>"
                                                                                class="form-control form-control-sm time-range <?php echo e(isset($timeRange['type']) && $timeRange['type'] === 'SL' ? 'sick-leave-entry' : ''); ?> <?php echo e($isOwnRoster ? 'own-roster-disabled' : ''); ?> <?php echo e($isApproved == 0 ? 'unapproved-input' : ''); ?>"
                                                                                data-sick-leave="<?php echo e(isset($timeRange['type']) && $timeRange['type'] === 'SL' ? 'true' : ''); ?>"
                                                                                data-approved="<?php echo e($isApproved); ?>"
                                                                                <?php echo e($isOwnRoster ? 'disabled' : ''); ?>>

                                                                            <?php if($isSpecialType): ?>
                                                                            <div class="time-pickers special-type <?php echo e($isOwnRoster ? 'roster-disabled' : ''); ?>" style="display: none;" data-day-off-type="<?php echo e($hiddenValue); ?>">
                                                                                <?php elseif($isOnCall): ?>
                                                                                <div class="time-pickers on-call-type d-flex align-items-center <?php echo e($isOwnRoster ? 'roster-disabled' : ''); ?>" style="flex: 1;">
                                                                                    <i class="fas fa-phone on-call-icon" style="color: #28a745; margin-right: 5px; font-size: 14px;"></i>
                                                                                    <?php elseif($isReception): ?>
                                                                                    <div class="time-pickers reception-type d-flex align-items-center <?php echo e($isOwnRoster ? 'roster-disabled' : ''); ?>" style="flex: 1;">
                                                                                        <i class="fas fa-desktop reception-icon" style="color: #007bff; margin-right: 5px; font-size: 14px;"></i>
                                                                                        <?php else: ?>
                                                                                        <div class="time-pickers d-flex align-items-center <?php echo e($isOwnRoster ? 'roster-disabled' : ''); ?>" style="flex: 1;">
                                                                                            <?php endif; ?>
                                                                                            ...
                                                                                            <div class="basic-time-row">
                                                                                                <input type="time"
                                                                                                    ...
                                                                                                    value="<?php echo e($displayStartTime); ?>"
                                                                                                    <?php echo e($isSpecialType || $isOwnRoster ? 'disabled' : ''); ?>>

                                                                                                <span class="time-separator mx-1">-</span>

                                                                                                <input type="time"
                                                                                                    class="form-control form-control-sm time-end"
                                                                                                    value="<?php echo e($displayEndTime); ?>"
                                                                                                    <?php echo e($isSpecialType || $isOwnRoster ? 'disabled' : ''); ?>>
                                                                                            </div>
                                                                                            <?php endif; ?>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="special-display d-flex align-items-center justify-content-center" style="flex: 1; padding: 5px; background-color: #f8f9fa; border-radius: 3px;">
                                                                                            <strong><?php echo e($hiddenValue); ?></strong>
                                                                                        </div>
                                                                                        <?php endif; ?>
                                                                                        ...
                                                                                        <script>
                                                                                            document.addEventListener('DOMContentLoaded', function() {
                                                                                                const container = document.getElementById('hidden-time-<?php echo e($staff->id); ?>-<?php echo e($dateString); ?>-<?php echo e($index ?? 0); ?>').closest('.time-input-container');
                                                                                                if (container) {
                                                                                        ...
                                                                                        <script>
                                                                                            document.addEventListener('DOMContentLoaded', function() {
                                                                                                ...
                                                                                                if (container) {
                                                                                                    ...
                                                                                                    container.setAttribute('data-day-off-type', '<?php echo e($hiddenValue); ?>');
                                                                                                }
                                                                                            });
                                                                                        </script>
                                                                                        <?php endif; ?>
                                                                                        ...
                                                                                        <div class="dropdown d-inline-block">
                                                                                            <button class="btn btn-sm btn-secondary dropdown-toggle <?php echo e($isOwnRoster ? 'disabled' : ''); ?>"
                                                                                                type="button"
                                                                                ...
                                                                                <div class="time-slot mb-1">
                                                                                    <div class="time-input-container">
                                                                                        ...
                                                                                        <input type="hidden"
                                                                                            name="hours[<?php echo e($staff->id); ?>][<?php echo e($dateString); ?>][]"
                                                                                            id="hidden-time-<?php echo e($staff->id); ?>-<?php echo e($dateString); ?>-0"
                                                                                            class="form-control form-control-sm time-range <?php echo e($isOwnRoster ? 'own-roster-disabled' : ''); ?>"
                                                                                            value=""
                                                                                            <?php echo e($isOwnRoster ? 'disabled' : ''); ?>>
                                                        ...
                                                        <?php if($department === 'Operations' && $displayMidnightPhone): ?>
                                                        <tr>
                                                            ...
                                                            <td class="<?php echo e(in_array($dateString, $holidays->toArray()) ? '' : ''); ?>">
                                                                <select name="midnight_phone[<?php echo e($dateString); ?>]" class="form-control form-control-sm">
                                                                    ...
                                                                    <?php $__currentLoopData = $allStaffFlattened; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allStaff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($allStaff->id); ?>"
                                                                        <?php echo e(($midnightPhoneData[$dateString] ?? '') == $allStaff->id ? 'selected' : ''); ?>>
                                                                        <?php echo e($allStaff->name); ?>
                                            ...
                                            <div class="mt-3 text-center">
                                                ...
                                                <div class="submit-button-container">
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">
                                                        ...
                                                        Submit <?php echo e($department); ?> Hours
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
...
<script>
            ...
            field.addEventListener('click', function() {
                ...
                if (timeInput.value) {
                    ...
                    if (currentTimeItems.length > 0) {
                        currentTimeItems[0].scrollIntoView({
                            block: 'center'
                        });
                    }
                }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function isPastEditingDeadline() {
            const now = new Date();
            const currentDay = now.getDate();
            const currentHour = now.getHours();
            
            // Check if we're past the 2nd day of the month at 12:00 PM
            return currentDay > 2 || (currentDay === 2 && currentHour >= 12);
        }

        // Function to check if user is an admin
        function isUserAdmin() {
            // Check if there's an admin status indicator in the page
            // You may need to adjust this based on how your app identifies admins
            return <?php echo e(Auth::user()->role === 'admin' ? 'true' : 'false'); ?>;
        }
        ...
        if (weekInput) {
            weekInput.addEventListener('change', function() {
                const url = `<?php echo e(route('supervisor.enter-working-hours')); ?>?week=${this.value}`;
                handleNavigation(url);
            });
        }
        ...
        document.querySelectorAll('.department-form').forEach(form => {
            form.addEventListener('submit', async function(e) {
                ...
                const department = departmentInput ? departmentInput.value : 'Unknown';
                        ...
                        // Check if we're past the editing deadline
        if (isPastEditingDeadline() && !isUserAdmin()) {
            // Get the selected week
            const weekInput = document.getElementById('week');
            const selectedWeek = new Date(weekInput.value);
            const selectedMonth = selectedWeek.getMonth();
            const currentMonth = new Date().getMonth();
            
            // If selected week is from previous month
            if (selectedMonth < currentMonth || 
                (selectedMonth === 11 && currentMonth === 0)) { // December to January case
                
                await Swal.fire({
                    title: 'Editing Restricted',
                    html: `
                        <div style="text-align: left;">
                            <p>You can only edit the previous month's data until 12:00 PM on the 2nd day of the current month.</p>
                            <p>If you need to make changes after this deadline, please contact HR.</p>
                        </div>
                    `,
                    icon: 'warning',
        ...
        const currentUserEmail = '<?php echo e(Auth::user()->email ?? ""); ?>';
...
<style>
    ...
    .table-responsive-container {
        ...
        cursor: grab;
        position: relative;
        /* For sticky elements to work properly */
    }
    ...
    .working-hours-table tbody td:first-child {
        font-weight: 500;
        /* Make staff names more prominent */
    ...
    .tab-content {
        padding-bottom: 80px;
        /* Add bottom padding to ensure submit button is visible */
    }
    ...
    @media (max-width: 768px) {
        ...
        .working-hours-table thead th:first-child {
            font-size: 0.7rem;
            /* Only change font size, not widths */
        }
    ...
    .time-pickers input[type="time"] {
        flex: 1;
        min-width: 80px;
        /* Minimum width for time inputs */
        max-width: 120px;
        /* Prevent inputs from getting too wide */
    }

    .time-pickers .mx-1 {
        flex-shrink: 0;
        /* Prevent the dash from shrinking */
        margin: 0 4px;
    }
    ...
    .dropdown .btn {
        padding: 4px 8px;
        /* Smaller padding for the dropdown button */
        font-size: 0.75rem;
        border: 1px solid #ced4da;
    }
    ...
    .working-hours-table tbody td:first-child {
        z-index: 6;
        /* Higher than regular header but lower than corner cell */
    }
    ...
    .time-slot {
        margin-bottom: 8px;
        /* Increased margin to accommodate error message */
        position: relative;
        /* Ensure proper positioning context */
        padding-bottom: 20px;
        /* Add bottom padding for error message space */
    }

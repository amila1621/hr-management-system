                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $tourDurations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tourDuration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(route('tour-durations.sauna-edit', $tourDuration->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                                                        <form action="<?php echo e(route('tour-durations.sauna-destroy', $tourDuration->id)); ?>" method="POST" style="display:inline-block;">
                                                            <?php echo csrf_field(); ?>
                    ...
                    <div class="col-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?php echo e(route('tour-durations.sauna-store')); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('partials.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nordpzbm/hr.nordictravels.tech/resources/views/tour_duration/sauna-index.blade.php ENDPATH**/ ?>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $receipts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receipt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <td><?php echo e($receipt->amount); ?></td>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" onclick="showReceiptModal('<?php echo e(Storage::url($receipt->receipt)); ?>')">
                                                ...
                                                <td>
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <?php if($receipt->rejection_reason): ?>
                                                        <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo e($receipt->rejection_reason); ?>"></i>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </td>
                                                    ...
                                                    <div class="btn-group">
                                                        <?php if(auth()->user()->role === 'admin'): ?>
                                                            <button type="button" 
                                                                    ...
                                                                    onclick="updateStatus(<?php echo e($receipt->id); ?>, 2, '<?php echo e($receipt->applied_month ?? ''); ?>')"
                                                            ...
                                                            <button type="button" 
                                                                    ...
                                                                    onclick="showRejectModal(<?php echo e($receipt->id); ?>)"
                                                                    title="Reject"> Reject
                    ...
                    <div id="accountingDetails">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="accountingCategory" required>
                                ...
                                <?php $__currentLoopData = $accountingCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('supervisors.update', $supervisor->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <div class="form-group">
                                        <label for="name">Name</label>
                                        <input type="text" name="name" class="form-control"
                                            value="<?php echo e(old('name', $supervisor->user->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            value="<?php echo e(old('email', $supervisor->user->email)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_number" class="form-control"
                                            value="<?php echo e(old('phone_number', $supervisor->phone_number)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="rate" class="form-control"
                                            value="<?php echo e(old('rate', $supervisor->rate)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="color" class="form-control"
                                            value="<?php echo e(old('color', $supervisor->color)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="display_midnight_phone" class="form-control">
                                            ...
                                            <option value="1" <?php echo e(old('display_midnight_phone', $supervisor->display_midnight_phone) == '1' ? 'selected' : ''); ?>>Yes</option>
                                        </select>
...
<?php echo $__env->make('partials.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nordpzbm/hr.nordictravels.tech/resources/views/users/supervisors-edit.blade.php ENDPATH**/ ?>
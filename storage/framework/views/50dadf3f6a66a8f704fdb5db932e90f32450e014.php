                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="reportForm" action="<?php echo e(route('reports.getGuideTimeReport')); ?>" method="GET">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('partials.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nordpzbm/hr.nordictravels.tech/resources/views/reports/guide-time-report-create.blade.php ENDPATH**/ ?>
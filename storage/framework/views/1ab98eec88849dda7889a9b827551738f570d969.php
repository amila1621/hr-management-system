                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="manualTourForm" action="<?php echo e(route('tours.store-manual')); ?>" method="POST" onsubmit="return validateShiftDurations()">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('partials.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nordpzbm/hr.nordictravels.tech/resources/views/tours/create-a-new-tour.blade.php ENDPATH**/ ?>
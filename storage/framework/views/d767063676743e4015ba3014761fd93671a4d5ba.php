...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row mb-3" style="z-index: 1000; position: fixed; top: -6px; margin: 0px 40px 10px 20px;">
                    <h4 class="page-title" style="margin: 25px 40px 0px 20px;">
                       <?php if(auth()->user()->role === 'team-lead'): ?>
                            Bus Driver Report - <?php echo e($tourGuide->name); ?>


                        <?php else: ?>
                            <?php echo e($tourGuide->name); ?> - Guide Report
                        <?php endif; ?>
                    </h4>

                    <div class="col-md-6" style="margin-top: 23px;">
                        <form action="<?php echo e(route('guide.report-by-month', ['guideId' => ':guideId'])); ?>" method="GET"
                                ...
                                <select name="guide_id" id="guide_id" class="form-control" onchange="this.form.submit()">
                                    <?php $__currentLoopData = $tourGuides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($guide->id); ?>"
                                            <?php echo e($guide->id == $tourGuide->id ? 'selected' : ''); ?>><?php echo e($guide->name); ?>
                                ...
                                <select name="year" id="year" class="form-control" onchange="this.form.submit()">
                                    <?php for($i = date('Y'); $i >= date('Y') - 5; $i--): ?>
                                        <option value="<?php echo e($i); ?>"
                                            <?php echo e(request('year', date('Y')) == $i ? 'selected' : ''); ?>><?php echo e($i); ?>
                                ...
                                <select name="month" id="month" class="form-control" onchange="this.form.submit()">
                                    <?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($month); ?>"
                                            <?php echo e(request('month', date('n')) == $month ? 'selected' : ''); ?>>
                                ...
                                <div style="max-height: 600px; overflow-y: auto;">
                                    <div class="table" style="margin: 10px 0px 10px 0px;">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered"
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $eventSalaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $dailySalaries): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    
                                                    
                                                    
                                                    <?php $__currentLoopData = $dailySalaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr data-event-id="<?php echo e($salary->event->id); ?>" data-salary-id="<?php echo e($salary->id); ?>">
                                                        ...
                                                        <td>
                                                            <?php if(!empty($salary->guide_start_time)): ?>
                                                                <?php echo e($salary->guide_start_time->format('d.m.Y H:i')); ?>
                                                        ...
                                                        <td>
                                                            <?php if(!empty($salary->guide_end_time)): ?>
                                                                <?php echo e($salary->guide_end_time->format('d.m.Y H:i')); ?>

                                                            <?php else: ?>
                                                                N/A
                                                            <?php endif; ?>
                                                        </td>
                                                        <td <?php if(Str::startsWith($salary->event->event_id, 'manual')): ?> style="color: #da76de;" <?php endif; ?>><?php echo e($salary->event->name); ?></td>
                                                        ...
                                                        <?php if(auth()->user()->role === 'admin' || auth()->user()->role === 'hr-assistant'): ?>
                                                            <td>
                                                                <button class="fa fa-pen btn btn-primary btn-bg" title="Update Hours"
                                                                    onclick="openManualEntryModal('<?php echo e($salary->event->id); ?>', '<?php echo e($salary->guide_start_time); ?>', '<?php echo e($salary->guide_end_time); ?>')">
                                                                </button>
                                                                <button class="fa fa-plus btn btn-success btn-bg" title="Add Extra Hours"
                                                                    onclick="openExtraHoursModal('<?php echo e($salary->id); ?>')"></button>
                                                                
                                                                <a href="<?php echo e(route('work-hours.delete', $salary->id)); ?>"
                                            ...
                                            <?php if(auth()->user()->role === 'admin'): ?>
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th></th>
                                                        <th></th>
                                                        <th><?php echo e(formatTime($totalNormalHours)); ?></th>
                                                        <th><?php echo e(formatTime($totalHolidayHours)); ?></th>
                                                        <th><?php echo e(formatTime($totalNormalNightHours)); ?></th>
                                                        <th><?php echo e(formatTime($totalHolidayNightHours)); ?></th>
                                                        <th></th>
                                                    </tr>
                                                </tfoot>
                                            <?php endif; ?>
    ...
    <div class="modal fade" id="extraHoursModal" tabindex="-1" role="dialog" aria-labelledby="extraHoursModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="extraHoursForm" action="<?php echo e(route('salary.add-extra-hours')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <script>
        var tourGuides = <?php echo json_encode($tourGuides, 15, 512) ?>;
        ...
        document.getElementById('manualEntryForm').addEventListener('submit', function(e) {
            ...
            fetch("<?php echo e(route('salary.manual-calculation-ajax')); ?>", {
                method: 'POST',
                headers: {
        ...
        document.getElementById('extraHoursForm').addEventListener('submit', function(e) {
            ...
            fetch("<?php echo e(route('salary.add-extra-hours-ajax')); ?>", {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                    'Accept': 'application/json',

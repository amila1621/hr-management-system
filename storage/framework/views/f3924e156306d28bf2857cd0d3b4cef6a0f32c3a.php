                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge badge-success">Approved By Supervisor / Pending with HR</span>
                                            ...
                                            <td>
                                                <a href="<?php echo e(Storage::url($receipt->receipt)); ?>"
                                                    class="btn btn-primary btn-sm"
                                                    target="_blank">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <?php if($receipt->status == 0 && (auth()->user()->role === 'admin' || auth()->id() === $receipt->user_id)): ?>
                                                <form action="<?php echo e(route('receipts.destroy', $receipt->id)); ?>"
                                                    method="POST"
                                                    class="d-inline"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('partials.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nordpzbm/hr.nordictravels.tech/resources/views/receipts/manage.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
                            ...
                            <?php endif; ?>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable-buttons"
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $eventes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($evente->name); ?></td>
                                                    <td><?php echo e(\Carbon\Carbon::parse($evente->start_time)->format('d.m.Y')); ?></td>
                                                    <td> 
                                                        <?php if($evente->status != 1): ?>
                                                            <div class="btn-group" role="group">
                                                                <a class="btn btn-secondary" style="color:aquamarine" href="/event-salary/<?php echo e($evente->id); ?>">Calculate Hours</a>
                                                                <button class="btn btn-info" 
                                                                        data-event-id="<?php echo e($evente->id); ?>" 
                                                                        onclick="calculateWithAI(this)">Calculate with AI</button>
                                                                <button class="btn btn-warning btn-sm" onclick="ignoreEvent('<?php echo e($evente->id); ?>')">Ignore</button>
                                                                <button class="btn btn-primary btn-sm" onclick="openManualEntryModal('<?php echo e($evente->id); ?>')">Add Manually</button>
                                                            </div>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
    ...
    <script>
        ...
        function calculateWithAI(element) {
            ...
            $.ajax({
                url: '<?php echo e(route("ai.analyze-event")); ?>',
                method: 'POST',
                data: {
        ...
        function confirmAICalculation() {
            ...
            $.ajax({
                url: '<?php echo e(route("salary.calculate-from-ai")); ?>',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
    ...
    function calculatePickupDuration(input) {
        ...
        $.ajax({
            url: '<?php echo e(route("calculate.pickup.duration")); ?>',
            method: 'POST',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
                location: location
...
<?php echo $__env->make('partials.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nordpzbm/hr.nordictravels.tech/resources/views/view-events.blade.php ENDPATH**/ ?>
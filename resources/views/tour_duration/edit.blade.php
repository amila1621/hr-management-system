            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">{{ isset($tourDuration) ? 'Edit Tour Duration' : 'Add New Tour Duration' }}</h4>
                                <form method="POST" action="{{ isset($tourDuration) ? route('tour-durations.update', $tourDuration->id) : route('tour-durations.store') }}">
                                    @csrf

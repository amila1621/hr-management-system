                                        ...
                                        <tbody>
                                            @foreach($tourDurations as $tourDuration)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('tour-durations.edit', $tourDuration->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                                        <form action="{{ route('tour-durations.destroy', $tourDuration->id) }}" method="POST" style="display:inline-block;">
                                                            @csrf
                                                            @method('DELETE')
                    ...
                    <div class="col-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('tour-durations.store') }}">
                                    @csrf

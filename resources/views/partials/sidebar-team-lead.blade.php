...
<li>
    <a href="javascript:void(0);" class="waves-effect">
        <i class="fas fa-calculator"></i><span> Accountant  
            <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
        </span>
    </a>
    <ul class="submenu">
...
<li>
    ...
    <ul class="submenu">
        ...
        <li><a href="{{ route('supervisor.staff-report') }}"> Office Staff Report</a></li>
        <li><a href="{{ route('reports.accountant-report-create') }}"> Guide Accountant Report</a></li>
        <li><a href="{{ route('reports.staff-report-create') }}"> Staff Accountant Report</a></li>
...
<li>
    <a href="{{ route('manager.guide-report') }}" class="waves-effect">
        <i class="fas fa-clipboard-list"></i><span> Bus Driver Report </span>
    </a>
</li>

                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        <tbody>
                                            @foreach ($hrAssistants as $hrAssistant)
                                                <tr>
                                                    <td>{{ $hrAssistant->name }}</td>
                                                    <td>{{ $hrAssistant->email }}</td>
                                                    <td>{{ $hrAssistant->hrAssistant->phone_number }}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="{{ route('hr-assistants.destroy', $hrAssistant->id) }}"
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-warning"
                                                            data-toggle="modal"
                                                            data-target="#changePasswordModal{{ $hrAssistant->id }}">
                                                            Change Password
                                                        </button>
                                                    </td>
                                                </tr>
                                                ...
                                                <div class="modal fade" id="changePasswordModal{{ $hrAssistant->id }}"
                                                    tabindex="-1" role="dialog"
                                                    aria-labelledby="changePasswordModalLabel{{ $hrAssistant->id }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="changePasswordModalLabel{{ $hrAssistant->id }}">
                                                                    Change Password for {{ $hrAssistant->name }}</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route('operations.change-password', $hrAssistant->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PUT')

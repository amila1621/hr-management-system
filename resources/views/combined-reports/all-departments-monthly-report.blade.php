        ...
        <div class="container-fluid">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-title-box">
                            <h4 class="page-title">NUT Staff Monthly Report - {{ \Carbon\Carbon::parse($monthYear)->format('F Y') }}</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="javascript:void(0);">Home</a>
                                </li>
                                <li class="breadcrumb-item">
                                    <a href="{{ route('combined-reports.all-departments.create') }}">All Departments Reports</a>
                                </li>

            ...
            <div class="container-fluid">
                ...
                <div class="row mb-3" style="z-index: 1000; position: fixed; top: -6px; margin: 0px 40px 10px 20px;">
                    ...
                    <div class="col-md-6" style="margin-top: 23px;">
                        <form action="{{ route('reports.getGuideWiseCustomReport', ['guide_id' => ':guideId']) }}" method="GET"
                            ...
                            <div class="form-group mr-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="start_date" class="form-control"  value="{{$startDate->format('Y-m-d')}}" required  onchange="this.form.submit()">
                                </div>
                            ...
                            <div class="form-group mr-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="end_date" class="form-control"  value="{{$endDate->format('Y-m-d')}}" required  onchange="this.form.submit()">
                                </div>
                            </div>
                        </form>
                    </div>

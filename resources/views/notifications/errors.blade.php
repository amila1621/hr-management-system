    ...
    <div class="content-page">
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Date Filter Form -->
                <form action="{{ route('errors.filter') }}" method="GET" class="form-inline mb-4">
                        ...
                        <ul>
                            @foreach ($errors as $error)
                                <li>
                                    ...
                                    <button class="btn btn-warning btn-sm ignore-event" data-event-id="{{ $error['eventId'] }}">Ignore</button>
                                    <button class="btn btn-primary btn-sm open-manual-entry" data-event-id="{{ $error['eventId'] }}">Add Manually</button>
                                </li>
                                <br>
                            @endforeach
                        </ul>

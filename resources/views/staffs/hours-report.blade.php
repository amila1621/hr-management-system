                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($dailyHours as $date => $data)
                                                @php 
                                                    $shifts = $data['shifts'] ?? [];
                                                    $isApproved = $data['is_approved'] ?? 1; // Get approval status
                                                ...
                                                @if(count($regularShifts) > 0)
                                                    @foreach($regularShifts as $index => $shift)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ sprintf('%02d:%02d', $shift['night_hours'] ?? 0, $shift['night_minutes'] ?? 0) }}</td>
...
<style>
    ...
    body { overflow-y: auto !important; font-size: 14px; -webkit-overflow-scrolling: touch; }
